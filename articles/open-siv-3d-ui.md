---
title: "【OpenSiv3D】真面目にSiv3Dで凝ったUIを作ってみる"
emoji: "🐠"
type: "tech"
published: false
...
![Pasted-image_20251209192439](/images/Pasted-image_20251209192439.png)  
...
結構色々機能が詰め込まれた独自ボタン。ホバーとか自分で作るの結構(心理的に)しんどいので、拡張性に優れたUI系の機能かライブラリが欲しいところ(もしかして：[明日の記事](https://qiita.com/m4saka/items/5bcfb90ef6b78278ca19))。  

基本的にはアイコンとコストのあるボタンで、それに加えて何個そのキリミを使用可能か、次使用可能になるまでををわかりやすくする機能がある感じ。(マウスホバーは機能していないかも。)  
### パレット
...
![Pasted-image_20251210000303](/images/Pasted-image_20251210000303.png)  
...
ちなみに本来はここに敵味方のユニット表示とかもしたかったです。  
# 終わりに  
遅刻になってしまい誠に申し訳ございません。。  
今回初めてちゃんと(？)siv3dで開発したのですが、前の印象通り取っつきやすく、2Dに置いては非常にｲｲｶﾝｼﾞなエンジンであると思いました。(今回ほぼロジック部分をメンバーがやってくれたため、自分はほぼUIの部分しか触っていませんが。)  
...
(ドキュメントちゃんと読めてなかったり、色々組み合わせようとすると癖があったりとちゃんと苦戦することはありました)  

---
ここまでお読みいただきありがとうございました。初心者ゆえ至らぬ点もあるかと思います。何か気になる点があれば優しく指摘してもらえると嬉しいです。

最後に、このような環境・機械を提供いただいた[@Ryo Suzuki](https://x.com/Reputeless)さんとSiv3Dのコミュニティに改めて感謝いたします。今後も成長していくSiv3Dに触れられることを楽しみにしております。